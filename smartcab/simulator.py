...
# set working directory (run only once)
import os
source_path = "/Users/linzhu/Documents/mooc"
target_path = "/mlnd/machine-learning/projects/smartcab"
os.chdir(source_path + target_path)
